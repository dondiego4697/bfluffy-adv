import {postRequest, getRequest} from 'common/lib/request';
...
async function createAd(params: CreateAdParams) {
    ...
    return postRequest<CreateAdResponse>(
        '/api/v1/private/animal_ad/create',
        {
            title,
            description,
            address,
...
async function getUserAd(publicId: string) {
    return getRequest<AdInfo>('/api/v1/private/animal_ad/info', {
        params: {publicId},
        responseType: 'json'
    });
}
...
async function getUserAds() {
    return getRequest<AdItem[]>('/api/v1/private/animal_ad/list', {
        responseType: 'json'
    });
}
...
async function updateAd(publicId: string, params: CreateAdParams) {
    ...
    return postRequest<CreateAdResponse>(
        '/api/v1/private/animal_ad/update',
        {
            name,
            description,
            address,
...
async function uploadImage(file: File) {
    ...
    return postRequest<UploadImageResponse>('/api/v1/private/s3_storage/upload_ad_image', formData, {
        responseType: 'json',
        headers: {
...
export const PrivateAdRequestBookV1 = {
    createAd,
    getUserAd,
    getUserAds,
    updateAd,
